# -*- coding: utf-8 -*-
#
# EasyVision documentation build configuration file, created by
...
version = EasyVision.__version__
# The full version, including alpha/beta/rc tags.
release = EasyVision.__version__
...
html_logo = "./_static/EasyVision-logo.png"
html_favicon = "./_static/EasyVision-favicon.ico"
...
htmlhelp_basename = 'EasyVisiondoc'
...
latex_documents = [
    (master_doc, 'EasyVision.tex', 'EasyVision Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'EasyVision', 'EasyVision Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EasyVision', 'EasyVision Documentation',
     author, 'EasyVision', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from EasyVision.docs import doc_data
except:
    doc_data = dict()
...
package_name = EasyVision.__name__
